...
MODEL=${MODEL:-"/var/models/ibm/granite-3.1/granite-3.1-1b-a400m-instruct-Q6_K_L.gguf"}

./git/build/bin/llama-bench -p 10 -n 10 -r 10 -m ${MODEL} -fa 1 ${LLAMA_BENCH_OPTS}
